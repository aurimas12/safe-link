...
export const BASEMAPS: Basemap[] = [
  { id: 'dark', label: 'Dark', style: 'https://tiles.openfreemap.org/styles/dark', buildingColor: '#334155', boundaryColor: '#e2e8f0' },
  { id: 'light', label: 'Light', style: 'https://tiles.openfreemap.org/styles/positron', buildingColor: '#cbd5e1', boundaryColor: '#2563eb' },
  { id: 'color', label: 'Color', style: 'https://tiles.openfreemap.org/styles/liberty', buildingColor: '#d6d3d1', boundaryColor: '#2563eb' },
  { id: 'satellite', label: 'Satellite', style: SATELLITE_STYLE, buildingColor: '#94a3b8', boundaryColor: '#facc15', maxZoom: SATELLITE_MAX_ZOOM },
]
